...
{$R *.dfm}
    ...
    //C:\Users\hieut\OneDrive\ƒÓÍÛÏÂÌÚ˚\GitHub\GarbageCollector\FREIGHT_TAXI_actual_changes.FDB
    //C:\Users\hieut\OneDrive\ƒÓÍÛÏÂÌÚ˚\GitHub\elephantSoftware\ELEPHANTSOFTWARE.FDB
...
begin
    ...
    if ParamByName('OUT_SUCCESS').value = 1 then begin
        worker_id := ParamByName('OUT_EMP_ID').value;
        role := ParamByName('OUT_JOB').value;
