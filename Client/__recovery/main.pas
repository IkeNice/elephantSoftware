...
begin
  ...
  lbDrivers.Left := (pnlHeader.Width div 3) - ((pnlHeader.Width div 3) div 2) - lbDrivers.l;
  lbStatus.Left := (pnlHeader.Width div 3) + ((pnlHeader.Width div 3) div 2);
  lbOrders.Left := (pnlHeader.Width div 3) + 2*((pnlHeader.Width div 3) div 2);
end;
